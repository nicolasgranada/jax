...
def index_array(x, indexers):
  ...
  for indexer in indexers:
    ...
    # Pattern match the requirements of `lax.slice` first. If not suitable,
    # try pattern matching the requirements of `lax.dynamic_slice`. If not
    # suitable, fallback to gather
